...
public final class ItemBuilder {
    ...
    public ItemBuilder displayName(String displayName) {
        return modifyItemMeta(
                itemMeta -> itemMeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', displayName)));
    }
    ...
    public ItemBuilder data(int data) {
        return modifyItemStack($ -> $.setData(new MaterialData($.getType(), (byte) data)));
    }
    ...
    public ItemBuilder lore(List<String> lore) {
        modifyItemMeta(meta -> meta.setLore(lore.stream()
